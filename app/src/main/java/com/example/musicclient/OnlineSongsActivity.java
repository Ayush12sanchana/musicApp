...
import com.example.musicclient.Adapter.JcSongsAdapter;
import com.example.musicclient.Model.GetSongs;
...
public class OnlineSongsActivity extends AppCompatActivity {
        ...
        valueEventListener = databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(checkin){
                    ...
                    Toast.makeText(OnlineSongsActivity.this, "there is no songs!", Toast.LENGTH_SHORT).show();
                }
            }
